...
/**
 * Delegated [Float] property that connects to OSC LED indicator represented by a single Float value.
 * Suited for TouchOSC's LED indicator.
 */
class OscLedIndicatorDelegate(
